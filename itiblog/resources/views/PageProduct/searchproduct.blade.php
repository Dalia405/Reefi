...
<body>
    ...
    <div class="container">
        <div class="nav-container">
          <nav class="noury">
           <a href="/searchproduct"> <h3   style="padding-top: 5px" class="logo" href="index.html">REEFI</h3></a>
 {{--search--}}
        ...
        <div class="product-under">
            ...
            <div class="product-summary">
                ...
                <p>
                    ...
                    <form action="/addsearchproduct/{{$product->id}}" method="POST" onsubmit="addAmountToCart(event)">
                        @csrf
                        <input type="text" value="{{$product->id}}" min="1"  id="idproduct" class="form-control" style="width:100px" name="idproduct" > 
