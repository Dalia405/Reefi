...
.login-wrap{
	...
	min-height:670px;
	position:relative;
	background:url(https://c.stocksy.com/a/mYt700/z9/1881872.jpg) no-repeat center;
...
.login-html .sign-up:checked + .tab{
	color:#fff;
	/*border-color:#1161ee;*/
    border-color:rgba(214, 114, 206, 0.9);
}
.login-form{
	min-height:345px;
	position:relative;
...
.login-form .group .button{
/*	background:#1161ee;*/
    background:rgba(214, 114, 206, 0.9);
}
