...
//add cart dairy
    public function adddairy(Request $request,$id)
    {
        ...
        if(Auth::id())
        {
          ...
          $img_path=$request->imageproduct;
          
            /*$id_product =Addproduct:: select("*")
            ->where('id_product',$id)
            ->exists();*/
            $user=auth()->user();
            $img_path_product =Addproduct:: select("*")
            ->where('img_path_product',$img_path)->where("username",$user->name)
            ->exists();
           // dd($id);
            if (  $img_path_product)
            {
              ...
              // $cart=Addproduct::where("id_product",$id)->first();
               $cart=Addproduct::where("img_path_product", $img_path)->where("username",$user->name)->first();
          ...
          // $input=$request->all();
           ...
           $addproduct-> img_path_product= $dairyproduct->img_path;
           $addproduct->save();
          // dd($addproduct-> img_path_product);
  ...
  if(Auth::id())
  {
    ...
    // dd( $img_path);
     /*$id_product =Addproduct:: select("*")
       ...
       $addprod-> img_path_product= $meatproduct->img_path;
       $addprod->save();
      // dd( $addprod-> img_path_product);
    ...
    // dd( $img_path);
     /*$id_product =Addproduct:: select("*")
      ...
      // $input=$request->all();
       ...
       $addpro->img_path_product = $otherproduct->img_path;
       $addpro->save();
      // dd($pageadd);
