            ...
            <div class="product-under">
                <figure class="product-image">
                    ...
                    <div class="product-over">
                       {{--<a href="shopping/{{$val -> id}}"--}}
                        <form action="/adddairy/{{$val->id}}" method="POST" onsubmit="addAmountToCart(event)">
                            @csrf
                            <input type="text" value="{{$val->id}}" min="1"  id="idproduct" class="form-control" style="width:100px" name="idproduct" hidden="">
                            <input type="text" value="{{$val->img_path}}" min="1"  id="idproduct" class="form-control" style="width:100px" name="imageproduct"  hidden="">
                        ...
                        {{--<form action="/pageadd/{{$val->id}}" method="POST" onsubmit="addAmountToCart(event)">
                            @csrf
                            <input type="number" value="1" min="1"  id="values" class="form-control" style="width:100px" name="quantity"> 
                           <br>
                           <button
